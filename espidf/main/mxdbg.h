...
typedef enum {
    ...
    TASK_LOW_FREQ_PWM_CONFIG = 0x09,
    TASK_LOW_FREQ_PWM_RUN_STOP = 0x0A,
    TASK_ADC_CONFIG = 0x10,
    TASK_ADC_READ = 0x11,
    TASK_SOFT_I2C_CONFIG = 0x20,
    TASK_SOFT_I2C_WRITE_READ = 0x21,
...
#define MXDBG_ERR_PWM_INVALID_FREQUENCY  ERR_SYNTHESIS(TASK_PWM_CONFIG, 0x04) /*!< Invalid PWM frequency */
...
// task_soft_i2c
#define MXDBG_ERR_SOFT_I2C_INVALID_PORT ERR_SYNTHESIS(TASK_SOFT_I2C_CONFIG, 0x00) /*!< Invalid SOFT I2C port */
#define MXDBG_ERR_SOFT_I2C_DEINIT_FAILED ERR_SYNTHESIS(TASK_SOFT_I2C_CONFIG, 0x01) /*!< SOFT I2C deinit failed */
#define MXDBG_ERR_SOFT_I2C_INIT_FAILED   ERR_SYNTHESIS(TASK_SOFT_I2C_CONFIG, 0x02) /*!< SOFT I2C init failed */
#define MXDBG_ERR_SOFT_I2C_INVALID_OPERATION ERR_SYNTHESIS(TASK_SOFT_I2C_WRITE_READ, 0x03) /*!< Invalid SOFT I2C operation */
#define MXDBG_ERR_SOFT_I2C_WRITE_READ_FAILED ERR_SYNTHESIS(TASK_SOFT_I2C_WRITE_READ, 0x04) /*!< SOFT I2C write read failed */